...
module tb_control_unit;
    ...
    initial begin
        // R-type ADD: opcode=0110011 funct3=000 funct7b5=0
        opcode = 7'b0110011; funct3 = 3'b000; funct7b5 = 1'b0;
        #1;
        check_bit(reg_write, 1'b1, "RTYPE_ADD_reg_write");
        check_vec(alu_op, 4'b0000, "RTYPE_ADD_alu_op");

        // R-type SUB: funct7b5=1
        opcode = 7'b0110011; funct3 = 3'b000; funct7b5 = 1'b1;
        #1 check_vec(alu_op, 4'b0001, "RTYPE_SUB_alu_op");

        // ADDI must stay ADD even with funct7b5=1 (those bits are immediate, not funct7)
        opcode = 7'b0010011; funct3 = 3'b000; funct7b5 = 1'b1;
        #1 check_vec(alu_op, 4'b0000, "ADDI_ignores_funct7b5");

        // SRLI vs SRAI distinguished by funct7b5
        opcode = 7'b0010011; funct3 = 3'b101; funct7b5 = 1'b0;
        #1 check_vec(alu_op, 4'b0110, "SRLI_alu_op");
        opcode = 7'b0010011; funct3 = 3'b101; funct7b5 = 1'b1;
        #1 check_vec(alu_op, 4'b0111, "SRAI_alu_op");

        // LOAD (LW): opcode=0000011
        opcode = 7'b0000011; funct3 = 3'b010; funct7b5 = 1'b0;
        #1;
